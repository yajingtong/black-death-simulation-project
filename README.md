...
This project is based on the black death out break in 1665,simulating the epidemic caused by rats.The model displays 3 map represents for the average rats caught per week per 100x100m,average population density per 100x100m,and the average death estimated per week per 100x100m.
